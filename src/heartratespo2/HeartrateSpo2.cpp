...
SensorReader::SensorReader() : rateSpot(0), lastBeat(0), beatsPerMinute(0), beatAvg(0), bufferLength(100) {
...
void SensorReader::calculateHeartRateAndSpO2() {
...
int SensorReader::getHeartRate() {
    return heartRate;
}

int SensorReader::getSpO2() {
    return spo2;
}

bool SensorReader::isHeartRateValid() {
    return validHeartRate;
}

bool SensorReader::isSpO2Valid() {
    return validSPO2;
}